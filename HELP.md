...
* The original package name 'com.example.magic-the-gathering-shell-application' is invalid and this project uses 'com.example.magicthegatheringshellapplication' instead.
...
```
$ docker run --rm -p 8080:8080 magic-the-gathering-shell-application:0.0.1-SNAPSHOT
```
...
```
$ target/magic-the-gathering-shell-application
```
